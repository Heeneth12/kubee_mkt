...
export default function HeroSection() {
  return (
    <section className="relative font-sans">
      ...
      <div className="absolute top-0 left-0 right-0  md:h-180" style={{
        background: `
            linear-gradient(180deg, #c8d6e5 0%, #dfe6ed 30%, #f0f0f0 70%, #e8e8e8 100%)
          `
      }} />
      ...
      {/* Hero Content */}
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-16 mb-12 text-center ">
        ...
        <p className="text-sm md:text-md  font-medium max-w-2xl mx-auto leading-relaxed">
